...
public class City implements Serializable {
    ...
    public City() {
        ...
        HashMap<String, Item> = new HashMap<>();
        someItems();
    }
    ...
    //Open00
    public City open00(String archivo) {
    ...
    //Save00
    public void save00(String archivo) {
        try {
    ...
    public void serializate() {
        String file = "oneCity.dat";
        save00(file);
    }

    public City deserializate() {
        String file = "oneCity.dat";
        City newCity = open00(file);
        return newCity;
    }

    //Open Con Parametro Archivo
    public City open(File file) {
        if (!file.exists()) {
            System.out.println("No se encontro el archivo");
            return null;
        }
    ...
    public void importFile(File cityTxt) throws CityException {

    }

//    public void exportFile(City city) throws CityException {
//        String file = "Schelling.txt";
//        try{
//            FileWriter writer = new FileWriter(file){
//            for(HashMap.Entry<String, Item> objects : items.entrySet()){
//              String name = objects.getKey();
//                String item = objects.getValues();
//                writer.write(name + " " + item.getRow() + " " + item.getColumn() + "\n")
//            }
//        }catch (IOException e){
//          throw new CityException("Error al exportar el archivo");
//        }
//    }
//
//    }
